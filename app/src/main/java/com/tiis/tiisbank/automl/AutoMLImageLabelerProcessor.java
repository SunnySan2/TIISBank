package com.tiis.tiisbank.automl;
...
import com.tiis.tiisbank.common.CameraImageGraphic;
import com.tiis.tiisbank.common.FrameMetadata;
import com.tiis.tiisbank.common.GraphicOverlay;
import com.tiis.tiisbank.VisionProcessorBase;
import com.tiis.tiisbank.labeldetector.LabelGraphic;
    ...
    FirebaseModelManager.getInstance()
        .registerLocalModel(
            new FirebaseLocalModel.Builder(LOCAL_MODEL_NAME)
                .setAssetFilePath("com/tiis/tiisbank/automl/manifest.json")
                .build());
